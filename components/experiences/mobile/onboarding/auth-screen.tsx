...
function AuthPicker({
  ...
  return (
    ...
    >
      <header style={{ display: "flex", alignItems: "center", fontSize: 11, color: sam.comment }}>
        <button
          type="button"
          onClick={onBack}
          disabled={busy}
      ...
      <main className="auth-picker-main">
  ...
  └─ ▸ google oauth      → vault access`}</pre>
      ...
      <footer className="auth-picker-footer">
